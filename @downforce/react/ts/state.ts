...
export type UseState1Contract<S, R = S> = {readonly value: S, get: StateReader<S>, set: StateWriter<S, R>}
export type UseState3Contract<S, R = S> = [...UseStateContract<S, R>, get: StateReader<S>]
